...
for model in "${models[@]}"; do
    for optimizer in "adam" "sgd" "adamw"; do
        ...
        echo "=========================================="
        python train.py --config config/${model}_${optimizer}.json --dataset intel --input_size 224 --batch_size 32 --use_tensorboard --tensorboard_log_dir results/tensorboard/${model}_${optimizer}_intel --use_wandb --wandb_project dl20251-cv --wandb_run_name ${model}_${optimizer}_intel
