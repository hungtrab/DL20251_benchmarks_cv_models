...
models=("lenet" "alexnet" "resnet18" "resnet34" "resnet50" "vgg16" "mobilenetv3_l" "mobilenetv3_s" "vit" "efficientnetv2_s" "efficientnetv2_m" "efficientnetv2_l" "resnet101" "inceptionv3" "vgg16_bn")
...
for model in "${models[@]}"; do
    for optimizer in "adam" "sgd" "adamw"; do
        ...
        echo "=========================================="
        python train.py --config config/${model}_${optimizer}.json --dataset mit --input_size 224 --batch_size 32 --use_tensorboard --tensorboard_log_dir results/tensorboard/${model}_${optimizer}_mit --use_wandb --wandb_project dl20251-cv --wandb_run_name ${model}_${optimizer}_mit
