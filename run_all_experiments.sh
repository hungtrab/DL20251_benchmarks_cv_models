...
python train.py --dataset cifar100_224 --model_name resnet50 --num_epochs 100 --config config/hpo_new/group_resnet_best.json --use_wandb --wandb_project dl20251 --input_size 224 --batch_size 64 --val --val_size 0.2 --eval_full --use_mixup --mixup_alpha 0.2 --use_cutmix --cutmix_alpha 1.0 --cutmix_prob 0.5 --use_sam --sam_rho 0.05 --label_smoothing 0.1 --adaptive_training
...
python train.py --dataset cifar100_224 --model_name efficientnetv2_m --num_epochs 250 --config config/hpo_new/group_modern_best.json --use_wandb --wandb_project dl20251 --input_size 224 --batch_size 64 --val --val_size 0.2 --eval_full --use_mixup --mixup_alpha 0.2 --use_cutmix --cutmix_alpha 1.0 --cutmix_prob 0.5 --use_sam --sam_rho 0.05 --label_smoothing 0.1 --adaptive_training
...
python train.py --dataset cifar100_224 --model_name efficientnetv2_l --num_epochs 250 --config config/hpo_new/group_modern_best.json --use_wandb --wandb_project dl20251 --input_size 224 --batch_size 64 --val --val_size 0.2 --eval_full --use_mixup --mixup_alpha 0.2 --use_cutmix --cutmix_alpha 1.0 --cutmix_prob 0.5 --use_sam --sam_rho 0.05 --label_smoothing 0.1 --adaptive_training
...
python train.py --dataset cifar100_224 --model_name mobilenetv3_l --num_epochs 250 --config config/hpo_new/group_modern_best.json --use_wandb --wandb_project dl20251 --input_size 224 --batch_size 64 --val --val_size 0.2 --eval_full --use_mixup --mixup_alpha 0.2 --use_cutmix --cutmix_alpha 1.0 --cutmix_prob 0.5 --use_sam --sam_rho 0.05 --label_smoothing 0.1 --adaptive_training
